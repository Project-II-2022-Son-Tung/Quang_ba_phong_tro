...
exports.OwnerMutationResponse = void 0;
...
let OwnerMutationResponse = class OwnerMutationResponse {
    code;
    success;
    message;
    owner;
...
], OwnerMutationResponse.prototype, "owner", void 0);
__decorate([
    (0, type_graphql_1.Field)(_type => [FieldError_1.FieldError], { nullable: true }),
    __metadata("design:type", Array)
], OwnerMutationResponse.prototype, "errors", void 0);
OwnerMutationResponse = __decorate([
    (0, type_graphql_1.ObjectType)({ implements: MutationResponse_1.IMutationResponse })
], OwnerMutationResponse);
exports.OwnerMutationResponse = OwnerMutationResponse;
//# sourceMappingURL=OwnerMutationResponse.js.map